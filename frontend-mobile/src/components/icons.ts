/**
 * The icons Renewly uses, imported one file each.
 *
 * Importing from the 'lucide-react-native' barrel pulls every icon into the bundle because Metro
 * does not tree-shake. Always import icons from here, and add new ones below as needed.
 */
